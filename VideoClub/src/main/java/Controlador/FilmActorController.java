...
public class FilmActorController {
        ...
        if (vista.getFilm() != null) {
            ...
            if (seleccion == 0) {
                ...
                if (actor != null) {
                    ...
                    if (filmAc == null) {
                        actorFilm.setFilm(vista.getFilm());
    ...
    public void filmActor() {
        CatalogoPeliculaTablaModelo mtc = (CatalogoPeliculaTablaModelo) catalogoPeliculas.getTablaCatalogoPeliculas().getModel();
        Film fi = mtc.getFilm(catalogoPeliculas.getTablaCatalogoPeliculas().getSelectedRow());
        vista.setCodigoPelicula(fi);
    }
